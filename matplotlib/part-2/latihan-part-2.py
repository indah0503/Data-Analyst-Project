...
plt.show()
# Hasil grafiknya banyak terkumpul di nilai-nilai kecil, sehingga tidak begitu terlihat detailnya di area situ.
# Untuk itu ditambahkan parameter lain mirip seperti pada Histogram di atas.
